      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-gray-700">
            ...
            <p>
              Our API provides robust endpoints for searching, filtering, and retrieving church data based on location, belief type, service languages, and more. It&#39;s the engine that powers our Church Explorer tool and is available for you to integrate into your own applications.
            </p>
            <p>
